...
int q1(char *data)
{
   ...
   //scanf("%s", data);
    ...
    char sMes[3];  
    char sAno[5];
    int i, j, k, iDia, iMes, iAno, iData;
  ...
  if (sAno > 1999 && sAno < 3000){
         return 1;
      
      if (sMes > 0 && sMes < 13){
            return 1;
            
            if ((sDia >= 1 && sDia <= 31) && (sMes == 1 || sMes == 3 || sMes == 5 || sMes == 7 || sMes == 8 || sMes == 10 || sMes == 12))
                return 1;

            else if ((sDia >= 1 && sDia <= 30) && (sMes == 4 || sMes == 6 || sMes == 9 || sMes == 11))
                return 1;

            else if ((sDia >= 1 && sDia <= 28) && (sMes == 2))
                return 1;

            else if ((sDia == 29 && sMes == 2) && ((int)sAno % 400 == 0 || (int)sAno % 4 == 0) && ((int)sAno % 100 != 0))
                return 1;
